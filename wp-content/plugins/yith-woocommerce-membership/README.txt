...
= 1.0.7 - Released: Sep 26, 2016 =

* Added: support to Wordpress 4.6.1
* Fixed: issue when deleting membership product

= 1.0.6 - Released: Aug 04, 2016 =

* Added: support to Wordpress 4.5.3
* Fixed: minor bugs

= 1.0.5 - Released: May 05, 2016 =

* Added: support to Wordpress 4.5.1
* Added: support to WooCommerce 2.5.5

= 1.0.4 - Released: Feb 16, 2016 =

* Added: support to WordPress 4.4.2
* Added: support to WooCommerce 2.5.2
* Tweak: fixed minor bug

= 1.0.3 - Released: Dec 01, 2015 =

* Tweak: fixed minor bug

= 1.0.2 - Released: Nov 17, 2015 =

* Fixed: minor bugs

= 1.0.1 - Released: Nov 09, 2015 =

* Tweak: improved Membership class
* Tweak: improved performance

= 1.0.0 - Released: Oct 06, 2015 =
